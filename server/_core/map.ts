...
function getMapsConfig(): MapsConfig {
  ...
  // ✅ CORRIGÉ: forgeApiUrl est optionnel, on utilise l'API OpenAI officielle par défaut
  if (!apiKey) {
    throw new Error(
      "Google Maps credentials missing: set OPENAI_API_KEY in environment variables"
    );
  }
